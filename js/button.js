document.getElementById('completed-btn-1').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Fix Mobile Button Issue' <span id="real-time-1"></span> </p>`
...
document.getElementById('completed-btn-2').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Add Dark Mode' <span id="real-time-2"></span> </p>`
...
document.getElementById('completed-btn-3').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Optimize  Home page ' <span id="real-time-3"></span> </p>`
...
document.getElementById('completed-btn-4').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Add new emoji 🤲' <span id="real-time-4"></span> </p>`
...
document.getElementById('completed-btn-5').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Integrate OpenAI API e' <span id="real-time-5"></span> </p>`
...
document.getElementById('completed-btn-6').addEventListener('click' , function(){
    ...
    if(taskText > 0){
        ...
        activity.innerHTML = 
        `<p class="m-5 p-5 text-sm bg-teal-100 font-bold rounded-lg text-start">'You Have Complete The Task Improve Job searching ' <span id="real-time-6"></span> </p>`
